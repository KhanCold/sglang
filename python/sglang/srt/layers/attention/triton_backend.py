...
class TritonAttnBackend(AttentionBackend):
    def __init__(
        ...
        if self.sliding_window_size is not None and swa_v_head_dim != full_v_head_dim:
            ...
            hybrid_gdn_config(model_runner_ref=model_runner) is not None
            or kimi_linear_config(model_runner_ref=model_runner) is not None
            or linear_attn_model_spec(model_runner_ref=model_runner) is not None
        ):
